...
import {
  PLATFORMS,
  ENTITY_TYPES,
} from '../../providers/odesli/odesli.constants';
...
export class LinksByEntityQuery {
  ...
  @ApiProperty({
    ...
    description: 'The unique identifier of the streaming entity.',
  })
  id: string;
  ...
  @ApiProperty({
    description:
      'Two-letter country code. Specifies the country/location we use when searching streaming catalogs.',
    default: 'US',
    required: false,
  })
